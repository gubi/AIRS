...
if(is_array($foaf_interest) && count($foaf_interest) > 0) {
	...
	foreach ($foaf_interest as $interest) {
		...
		$int_rows .= '<tr class="user_interest"><td><input type="text" style="width: 25%;" name="user_interest_type_' . $int_c . '" rel="interest" placeholder="Interesse" title="Interesse" value="' . str_replace(array("http://it.dbpedia.org/page/", "_"), array("", " "), urldecode($interest)) . '" />&emsp;<a href="javascript: void(0);" class="btn add" style="float: none;" title="Aggiungi un interesse">+</a>' . $int_remove_btn . '</td></tr>';
	}
} else {
	$int_rows = '<tr class="user_interest"><td><td><input type="text" style="width: 25%;" name="user_interest_type_$int_start_no" class="interest" placeholder="Interesse" title="Interesse" value="" />&emsp;<a href="javascript: void(0);" class="btn add" style="float: none;" title="Aggiungi un interesse">+</a></td></tr>';
}
