...
$content_body .= <<<Username_recovery
	...
	<fieldset>
		...
		<table cellspacing="5" cellpadding="5" class="frm">
			<tr>
				...
				<td>
					<input type="email" name="email" id="email" value="" tabindex="1" required="required" />
				</td>
				<td></td>
			</tr>
			<tr>
				...
				<td>
					<input type="password" name="password" id="password" value="" tabindex="2" required="required" />
				</td>
				<td></td>
			</tr>
			<tr><td>&nbsp;</td></tr>
