...
define('WORDNET_NS', 'http://xmlns.com/wordnet/1.6/');
define('CONTACT_NS', 'http://www.w3.org/2000/10/swap/pim/contact#');
define('RELATIONSHIP_NS', 'http://purl.org/vocab/relationship/');
