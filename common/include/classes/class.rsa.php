...
class rsa {
	...
	*/
	...
	public function simple_private_encrypt($string) {
		shell_exec("echo '" . $string . "' | openssl rsautl -encrypt -inkey common/include/conf/rsa_2048_priv.pem > common/include/conf/message.encrypted");
		$encrypted = shell_exec('cat common/include/conf/message.encrypted | base64 - && rm common/include/conf/message.encrypted');
		return $encrypted;
	}
